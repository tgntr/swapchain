...
// source: interchainswap/types.proto
...
func (*QueryOsmosisSpotPriceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_458367096b62830c, []int{0}
}
...
func (m *QueryOsmosisSpotPriceRequest) GetPoolId() uint64 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
func (m *QueryOsmosisSpotPriceRequest) GetBaseAssetDenom() string {
	if m != nil {
...
func (m *QueryOsmosisSpotPriceRequest) GetQuoteAssetDenom() string {
	if m != nil {
...
func (*QueryOsmosisSpotPriceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_458367096b62830c, []int{1}
}
...
func (m *QueryOsmosisSpotPriceResponse) GetSpotPrice() string {
	if m != nil {
		return m.SpotPrice
	}
	return ""
...
func init() {
	proto.RegisterType((*QueryOsmosisSpotPriceRequest)(nil), "tgntr.swapchain.interchainswap.QueryOsmosisSpotPriceRequest")
	proto.RegisterType((*QueryOsmosisSpotPriceResponse)(nil), "tgntr.swapchain.interchainswap.QueryOsmosisSpotPriceResponse")
}

func init() { proto.RegisterFile("interchainswap/types.proto", fileDescriptor_458367096b62830c) }

var fileDescriptor_458367096b62830c = []byte{
	// 264 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *QueryOsmosisSpotPriceRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.QuoteAssetDenom) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.QuoteAssetDenom)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BaseAssetDenom) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.BaseAssetDenom)))
		i--
		dAtA[i] = 0x12
	}
	if m.PoolId != 0 {
...
func (m *QueryOsmosisSpotPriceResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SpotPrice) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.SpotPrice)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
